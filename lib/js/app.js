    ...
    var app = {
      ...
      insertBox: function insertBox() {
        for (var i = 0; i < this.finalImages.length; i++) {
          this.$startBoxes.append("<div class = \"box\">\n              <img src = \"img/".concat(this.finalImages[i], ".png\" alt = \"image\">\n            </div>"));
        }
      },
      countDown: function countDown() {
        var self = this;
        this.resultImages = [];
        this.$startBoxes.animate({
          "opacity": "0"
        }, 1000);
        setTimeout(function () {
          self.$resultBoxes.animate({
            "opacity": "1"
          }, 1000);
        }, 1500);
        $('.box').each(function () {
        ...
        for (var i = 0; i < this.resultImages.length; i++) {
          this.$resultBoxes.append("<div class = \"box\">\n              <img src = \"".concat(this.resultImages[i], "\" alt = \"img\">\n            </div>"));
        }
      },
